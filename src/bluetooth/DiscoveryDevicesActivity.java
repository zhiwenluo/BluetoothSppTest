...
public class DiscoveryDevicesActivity extends Activity
{
	...
	protected void showDevices()
	{
        ...
        if (null == this.msaListItemAdapter)
        {
	        ...
	        this.msaListItemAdapter = new SimpleAdapter(this,malListItem,//数据源   
	            R.layout.bluetooth_device_name,//ListItem的XML实现  
	            //动态数组与ImageItem对应的子项          
    ...
    private class scanDeviceTask extends AsyncTask<String, String, Integer>
    {
		...
		{
	    	/*定义进程对话框*/
			this.mpd = new ProgressDialog(DiscoveryDevicesActivity.this);
		...
		public void onPostExecute(Integer result)
		{
			...
			{	//提示蓝牙未启动
				Toast.makeText(DiscoveryDevicesActivity.this, getString(R.string.actDiscovery_msg_bluetooth_not_start), 
	 					   Toast.LENGTH_SHORT).show();
			}
		}
    }
